...
public class ApiTestSupport {
    ...
    protected ResultActions postJson(String endpoint, Object request, String accessToken) throws Exception {
        return mockMvc.perform(post(endpoint)
    ...
    protected ResultActions patchJson(String endpoint, Object request, String accessToken) throws Exception {
        return mockMvc.perform(patch(endpoint)
                .header("Authorization", "Bearer " + accessToken)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(request)));
    ...
    public String postJsonAndReturnId(String endpoint, Object request, String accessToken) throws Exception {
        String response = postJson(endpoint, request, accessToken)
    ...
    public String postJsonAndReturnField(
        ...
        String response = postJson(endpoint, request)
