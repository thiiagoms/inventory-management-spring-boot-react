...
public class UserFinderTest {
  ...
  void itReturnsAnUserWhenTheProvidedIdExists() {
    var expectedUser = UserFake.start().withId(id).build();
  ...
  void itReturnsAnUserWhenTheProvidedEmailExists() {
    var expectedUser = UserFake.start().withEmail(email).build();
  ...
  void itRejectsAnUnknownUserId() {
    UserNotFoundException exception =
        assertThrows(UserNotFoundException.class, () -> service.byId(id));
  ...
  void itRejectsAnUnknownUserEmail() {
    UserNotFoundException exception =
        assertThrows(UserNotFoundException.class, () -> service.byEmail(email));
