...
public class IdTest {
  ...
  @ValueSource(
      strings = {"541d5c1e-2c6b-4a85-a35c-8ab3b4961b2b", "019e4279-8f37-7e21-b615-c2d8db59334b"})
  ...
  void shouldThrowExceptionWhenValueIsNullEmptyOrBlank(String value) {
    InvalidDomainArgumentException exception =
        assertThrows(InvalidDomainArgumentException.class, () -> new Id(value));
  ...
  @ValueSource(strings = {"invalid-id", "12345-6789", "not-even-close"})
